...
class FullVideoDetailView extends StatefulWidget {
  ...
  const FullVideoDetailView({super.key, required this.video});

  @override
  State<FullVideoDetailView> createState() => _FullVideoDetailViewState();
}

class _FullVideoDetailViewState extends State<FullVideoDetailView> {
  ...
  Widget _buildStatsRow() {
    return Row(
      children: [
        _statItem(Icons.visibility_outlined, "830"),
        const SizedBox(width: 15),
        _statItem(Icons.favorite_border, "5"),
        const SizedBox(width: 15),
        _statItem(Icons.file_download_outlined, "0"),
      ],
    );
  }

  Widget _statItem(IconData icon, String val) {
    return Row(
      children: [

/// status : "Success"
/// data : {"nextOfKinName":"Mother A","nextOfKinSurname":"SurnameB","nextOfKinCellNumber":"+263779627951","nextOfKinEmailAddress":"55 A Road Alexander Park","nextOfKinAddress":"5 Court Road Greendale","createdAt":"2024-11-18T09:02:15.202+00:00","updatedAt":"2024-11-18T09:02:56.625+00:00","id":2}
/// message : "Next of kin updated successfully"

class UpdateNextOfKinResponseModel {
  UpdateNextOfKinResponseModel({
      String? status, 
      Data? data, 
      String? message,}){
    _status = status;
  ...
  UpdateNextOfKinResponseModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  Data? _data;
  String? _message;
UpdateNextOfKinResponseModel copyWith({  String? status,
  Data? data,
  String? message,
}) => UpdateNextOfKinResponseModel(  status: status ?? _status,
  data: data ?? _data,
...
/// createdAt : "2024-11-18T09:02:15.202+00:00"
/// updatedAt : "2024-11-18T09:02:56.625+00:00"
/// id : 2
...
class Data {
  ...
  String? _updatedAt;
  num? _id;
Data copyWith({  String? nextOfKinName,
  String? nextOfKinSurname,
  String? nextOfKinCellNumber,
  String? nextOfKinEmailAddress,
  String? nextOfKinAddress,
  ...
  String? updatedAt,
  num? id,
}) => Data(  nextOfKinName: nextOfKinName ?? _nextOfKinName,

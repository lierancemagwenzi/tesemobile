/// status : "Success"
/// data : {"nextOfKinName":"Father A","nextOfKinSurname":"SurnameB","nextOfKinCellNumber":"+263779627951","nextOfKinEmailAddress":"55 A Road Alexander Park","nextOfKinAddress":"5 Court Road Greendale","createdAt":"2024-11-18T09:00:44.832+00:00","updatedAt":"2024-11-18T09:00:44.832+00:00","id":1}
/// message : "Next of kin created successfully"

class AddNextOfKinResponseModel {
  AddNextOfKinResponseModel({
      String? status, 
      Data? data, 
      String? message,}){
    _status = status;
  ...
  AddNextOfKinResponseModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  Data? _data;
  String? _message;
AddNextOfKinResponseModel copyWith({  String? status,
  Data? data,
  String? message,
}) => AddNextOfKinResponseModel(  status: status ?? _status,
  data: data ?? _data,

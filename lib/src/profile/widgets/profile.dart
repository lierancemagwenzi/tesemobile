...
class _ProfileScreenState extends StateMVC<ProfileScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    // VISIBILITY LOGIC: Explicitly define colors based on theme brightness
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildInfoHeader(context, textColor, borderColor),
                    const SizedBox(height: 16),
                    ...
                    if (_con.accountInfo != null) ...[
                      _buildSectionTitle("Banking & Identity", textColor),
                      const SizedBox(height: 8),
                      _buildInfoCard(
                        title: 'Banking info',
                        showDone: _con.accountInfo?.hasBank == true,
                    ...
                    const SizedBox(height: 24),
                    _buildSectionTitle("Terms and Policy", textColor),
                    const SizedBox(height: 8),
                    _buildInfoCard(
                      title: 'Terms and Conditions',
                      content: 'View our terms and conditions',
                    ...
                    const SizedBox(height: 24),
                    _buildSectionTitle("Account Security", textColor),
                    const SizedBox(height: 8),
                    _buildInfoCard(
                      title: 'Delete Account',
                      content: 'Delete your account and clear your data',
  ...
  // Logic Wrappers (Terms, Delete, Password remain unchanged but optimized for the new flow)
  void _navigateToTerms() {
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  void _handleDeleteAccount(BuildContext context) {
    showModalBottomSheet(
      ...
      backgroundColor: Colors.transparent,
      builder: (context) => AccountDeletionSheet(
        onProceed: (reason) => _showFinalConfirmationDialog(reason),
      ),
    );
  }
  ...
  void showUpdatePasswordDialog(BuildContext context) {
    showDialog(
      context: context,
      builder: (c) => UpdatePasswordDialog(
        onSubmit: (curr, newVal) async {
          bool? update = await _con.updatePassword({'password': newVal});
          if (update == true)
            Navigator.pushNamed(
              context,
              '/Login',

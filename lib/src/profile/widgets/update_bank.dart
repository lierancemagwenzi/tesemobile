...
class _UpdateBankWidgetState extends StateMVC<UpdateBankWidget> {
  ...
  late TextEditingController _bankAccountNamesController;
  late TextEditingController _bankBICCodeController;
  late TextEditingController _bankSwiftCodeController;
  ...
  void initState() {
    ...
    // Mapping existing data to controllers
    _bankNameController = TextEditingController(
      text: widget.accountInfo.bankName,
    );
    _bankBranchController = TextEditingController(
  ...
  Widget _buildAppBar(Color iconColor, Color borderColor) {
    return Padding(
      padding: const EdgeInsets.only(left: 16, right: 16, top: 8),
      child: Row(
        children: [
  ...
  Widget _buildHeaderText(Color titleColor, Color subColor) {
    return Center(
      child: Column(
        children: [
          Text(

...
class PayoutRequestWidget extends StatefulWidget {
  final PriceModel priceModel;
  const PayoutRequestWidget({super.key, required this.priceModel});

  @override
  _PayoutRequestWidgetState createState() => _PayoutRequestWidgetState();
}

class _PayoutRequestWidgetState extends StateMVC<PayoutRequestWidget> {
  late PaymentController _con;

  _PayoutRequestWidgetState() : super(PaymentController()) {
  ...
  void initState() {
    ...
    super.initState();
    _selectedCurrency = widget.priceModel.currency;
  ...
  void _submitForm() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (result == true) {
        ApiResponseModel? model = await _con.payoutRequest(formData);
        ...
        if (model != null) {
          ...
          CustomMessageHandler().showErrorSnakeBar(
            ...
            'Failed to create the payout request. Try again',
          );
        }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  // --- Content ---
                  Text(' Are you sure you want to send the payout request?'),
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          ...
          content: PopScope(
            ...
            child: const Text('Payout request sent successfully.'),
          ),
          actions: <Widget>[
            TextButton(
              child: const Text('OK'),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildTextField(
                            ...
                            label:
                                'Payout Amount (Max ${widget.priceModel.amount})',
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      validator: (value) {
        ...
        if ((num.tryParse(value) ?? 0) > (widget.priceModel.amount)) {
          return 'Enter a valid amount less than or equivalent to ${(widget.priceModel.amount).toStringAsFixed(2)}';
        }
        return null;
      },
    );
  ...
  Widget _buildCurrencyDropdown() {
    return DropdownButtonFormField<String>(
      ...
      items: [widget.priceModel.currency].map((String currency) {

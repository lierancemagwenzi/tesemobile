...
class RegistrationImagesWidget extends StatefulWidget {
  ...
  const RegistrationImagesWidget({super.key, required this.country});
...
class _RegistrationImagesWidgetState
  ...
  Future<void> detectAndroid() async {
    ...
    if (cameras.isNotEmpty) {
      ...
      CustomMessageHandler().showErrorSnakeBar(context, 'Camera not active!');
    }
  }
  ...
  bool documentValidator() {
    if (type == 'idcard') return idFront != null && idBack != null;
    if (type == 'passport') return passport != null;
    return false;
  }

  bool validator() => _con.selfie != null && documentValidator();
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text(
            "Please upload clear copies of your identification to secure your account.",
            textAlign: TextAlign.center,
            style: TextStyle(
          ...
          child: Column(
            ...
            children: [
              _buildUploadItem(
                ...
                subtitle: _con.selfie == null
                    ? "Scan your face"
                    : "Selfie Verified",
                icon: Icons.face_retouching_natural_rounded,
                isDone: _con.selfie != null,
                onTap: () =>
                    Platform.isAndroid ? detectAndroid() : checkLiveness(),
              ),
              const SizedBox(height: 16),
              _buildUploadItem(
                title: "ID Document",
                subtitle: !documentValidator()
                    ? "National ID Card"
                    : "Document Uploaded",
                icon: Icons.badge_outlined,
                isDone: documentValidator(),
                onTap: () => showModal(),
              ),
            ],
          ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: isDone ? brandGreen.withOpacity(0.5) : Colors.white10,
          ),
        ),
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color: isDone ? brandGreen : Colors.white.withOpacity(0.1),
              ),
              child: Icon(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    subtitle,
                    style: TextStyle(
                      color: isDone ? brandGreen : Colors.white54,
                      fontSize: 12,
                    ),
                  ),
                ],
      ...
      child: CustomButtons.filledButton(
        ...
        callback: () async {
          ...
          if (result != null && result.canProceed == true) {
            ...
            Navigator.pushNamed(context, '/VerifyDetails', arguments: reg);
          } else {
            CustomMessageHandler().showErrorSnakeBar(
              context,
              "Verification failed. Ensure your photos are clear and match your ID.",
            );
          }
        },
      ),

...
class FollowingChannelsWidget extends StatefulWidget {
  const FollowingChannelsWidget({super.key});

  @override
  StateMVC<FollowingChannelsWidget> createState() =>
      _FollowingChannelsWidgetState();
}

class _FollowingChannelsWidgetState extends StateMVC<FollowingChannelsWidget> {
  ...
  _FollowingChannelsWidgetState() : super(ClientUserController()) {
  ...
  void initState() {
    ...
    _con.listenForFollowingChannels();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return CustomOverlay(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text("Following Channels", style: theme.textTheme.titleLarge),
          actions: [
            IconButton(
              icon: Icon(
